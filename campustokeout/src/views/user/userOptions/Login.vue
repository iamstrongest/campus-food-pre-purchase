...
import Phone from "@/components/login/Email.vue";
import SchoolId from "@/components/login/SchoolId.vue"
import { loginStore } from '@/stores/user/login'
const store = loginStore();
let nowComponent = shallowRef(Phone);

const phoneLogin = (e: Evnet) => {
    nowComponent.value = Phone;
}
const idLogin = (e: Evnet) => {
    ...
    <div class="Login-container">
        ...
        <div class="traditional-login">
            <div class="choose-login">
                <span @click="phoneLogin">手机号码登录</span><span @click="idLogin">学号登录</span>
            </div>
            <keep-alive>
